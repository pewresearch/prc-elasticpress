		...
		<Fragment>
			...
			<div {...blockProps}>
				<RichText
					...
					className="wp-block-prc-ep-facet-template__label"
				/>
				<InnerBlocksAsContextTemplate
					{...{
						...
						wrapperProps: {
							className: 'wp-block-prc-ep-facet-template__list',
						},
					}}
				/>
				{'dropdown' !== facetType && (
					<button
						className="wp-block-prc-ep-facet-template__list-expanded-button"
						type="button"
					>
						+ More
					</button>
